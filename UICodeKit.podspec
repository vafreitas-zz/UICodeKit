...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tqi-valves/UICodeKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'valves' => 'vitoralves59@gmail.com' }
  s.source           = { :git => 'https://github.com/valves/UICodeKit.git', :tag => s.version.to_s }
